...
CREATE TABLE IF NOT EXISTS "usage_tracking" (
	...
	"email_events_processed" integer DEFAULT 0 NOT NULL,
...
CREATE INDEX IF NOT EXISTS "usage_tracking_user_period_idx" ON "usage_tracking" USING btree ("user_id","period_start");